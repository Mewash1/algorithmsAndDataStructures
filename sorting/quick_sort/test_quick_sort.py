...
def test_quick_sort_with_repetitions():
...
def test_quick_sort_benchmark_1000(benchmark):
    benchmark(quick_sort, pan_tadeusz[:1000])


def test_quick_sort_benchmark_2000(benchmark):
    benchmark(quick_sort, pan_tadeusz[:2000])


def test_quick_sort_benchmark_5000(benchmark):
    benchmark(quick_sort, pan_tadeusz[:5000])


def test_quick_sort_benchmark_7000(benchmark):
    benchmark(quick_sort, pan_tadeusz[:7000])


def test_quick_sort_benchmark_10000(benchmark):
    benchmark(quick_sort, pan_tadeusz[:10000])